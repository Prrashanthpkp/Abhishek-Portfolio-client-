...
const techTags = [
  'Python', 'C', 'JavaScript', 'HTML & CSS', 'LangChain',
  'LangFlow', 'FAISS', 'RAG', 'LLMs', 'TensorFlow',
  'NumPy', 'Pandas', 'OpenCV', 'YOLO', 'GCP',
  'Cloud Run', 'Node.js', 'Express', 'REST API', 'PostgreSQL',
  'MySQL', 'Streamlit', 'Excel', 'Power BI', 'Jupyter',
  'VSCode', 'Linux', 'Hoppscotch', 'Git', 'GitHub',
];
