        ...
        >
          ...
          <p style={{
            ...
            I'm an <span style={{ color: 'var(--amber)', fontWeight: 600 }}>
              AI & Data Science Engineer</span> from Chennai with experience 
            building production-ready intelligent systems — NL2SQL APIs, 
            RAG pipelines, and real-time computer vision models deployed 
          ...
          <p style={{
            ...
            Interned at Tvara (Bangalore) and CIRF (Chennai), where I worked 
            on Gemini LLM integrations, YOLO-based object detection, and 
            scalable cloud deployments. I enjoy turning complex, messy 
            problems into clean APIs and AI products that work in the real world.
          </p>

          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            {['LangChain', 'RAG', 'GCP', 'YOLO', 'PostgreSQL', 'Node.js', 'TensorFlow', 'Power BI'].map(t => (
